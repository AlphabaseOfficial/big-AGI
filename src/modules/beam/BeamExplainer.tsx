...
const beamSteps: ExplainerPage[] = [
  {
    ...
    // titleSquircle: true,
    mdContent: `
**Beam** is a chat modality in Alpha-AGI to engage multiple AI models, [together](https://alpha-agi.com/blog/beam-multi-model-ai-reasoning). 
...
![alpha-AGI BEAM Rays](https://alpha-agi.com/app/journeys/beam/explainer-beam-scatter-1200px-alpha.png)
...
![alpha-AGI BEAM Rays](https://alpha-agi.com/app/journeys/beam/explainer-beam-gather-1600px-alpha.png)
...
// There are profound reasons why this approach works, which we explore [in our blog](https://alpha-agi.com/blog/introducing-beam).
//
// #### Best Use
