...
export namespace GeminiWire_API_Models_List {
  ...
  const Methods_enum = z.enum([
    'bidiGenerateContent', // appeared on 2024-12, see https://github.com/enricoros/alpha-AGI/issues/700
    'createCachedContent', // appeared on 2024-06-10, see https://github.com/enricoros/alpha-AGI/issues/565
    'countMessageTokens',
    'countTextTokens',
    'countTokens',
    'createTunedModel',
