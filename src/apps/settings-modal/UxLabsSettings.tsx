  ...
  return <>
    ...
    {/*
      Other Graduated (removed or backlog):
        - <Link href='https://github.com/enricoros/alpha-AGI/issues/359' target='_blank'>Draw App</Link>
    ...
    */}
    ...
    <FormControl orientation='horizontal' sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      <Typography level='body-xs'>
        <Link href='https://alpha-agi.com/blog/beam-multi-model-ai-reasoning' target='_blank'>Beam</Link>
        {' · '}<Link href='https://github.com/enricoros/alpha-AGI/issues/208' target='_blank'>Split Chats</Link>
        {' · '}<Link href='https://github.com/enricoros/alpha-AGI/issues/354' target='_blank'>Call AGI</Link>
        {' · '}<Link href='https://github.com/enricoros/alpha-AGI/issues/282' target='_blank'>Persona Creator</Link>
        {' · '}<Link href='https://github.com/enricoros/alpha-agi/issues/192' target='_blank'>Auto Diagrams</Link>
