...
[Beams](https://github.com/enricoros/alpha-AGI/issues/470),
and [Calls](https://github.com/enricoros/alpha-AGI/issues/354) with AI personas,
...
[![Official Website](https://img.shields.io/badge/ALPHA--AGI.com-%23096bde?style=for-the-badge&logo=vercel&label=launch)](https://alpha-agi.com)

> 🚀 Alpha-AGI 2 is launching Q4 2024. Be the first to experience it before the public release.
>
...
- Alpha-AGI Stable: as deployed on alpha-agi.com
...
- [Beam](https://alpha-agi.com/blog/beam-multi-model-ai-reasoning) core and UX improvements based on user feedback
...
- YouTube Transcriber Persona for chatting with video content, [#500](https://github.com/enricoros/alpha-AGI/pull/500)
- Improved formula rendering (LaTeX), and dark-mode diagrams, [#508](https://github.com/enricoros/alpha-AGI/issues/508), [#520](https://github.com/enricoros/alpha-AGI/issues/520)
- Models update: **Anthropic**, **Groq**, **Ollama**, **OpenAI**, **OpenRouter**, **Perplexity**
- Code soft-wrap, chat text selection toolbar, 3x faster on Apple silicon, and more [#517](https://github.com/enricoros/alpha-AGI/issues/517), [507](https://github.com/enricoros/alpha-AGI/pull/507)

#### 3,000 Commits Milestone · April 7, 2024

![alpha-AGI Milestone](https://github.com/enricoros/alpha-AGI/assets/32999/47fddbb1-9bd6-4b58-ace4-781dfcb80923)
...
- ⚠️ [**Beam**: the multi-model AI chat](https://alpha-agi.com/blog/beam-multi-model-ai-reasoning). find better answers, faster - a game-changer for brainstorming, decision-making, and creativity. [#443](https://github.com/enricoros/alpha-AGI/issues/443)
- Managed Deployments **Auto-Configuration**: simplify the UI models setup with backend-set models. [#436](https://github.com/enricoros/alpha-AGI/issues/436)
- Message **Starring ⭐**: star important messages within chats, to attach them later. [#476](https://github.com/enricoros/alpha-AGI/issues/476)
- Enhanced the default Persona
- Fixes to Gemini models and SVGs, improvements to UI and icons
- 1.15.1: Support for Gemini Pro 1.5 and OpenAI Turbo models
- Beast release, over 430 commits, 10,000+ lines changed: [release notes](https://github.com/enricoros/alpha-AGI/releases/tag/v1.15.0), and changes [v1.14.1...v1.15.0](https://github.com/enricoros/alpha-AGI/compare/v1.14.1...v1.15.0)

<details>
<summary>What's New in 1.14.1 · March 7, 2024 · Modelmorphic</summary>

- **Anthropic** [Claude-3](https://www.anthropic.com/news/claude-3-family) model family support. [#443](https://github.com/enricoros/alpha-AGI/issues/443)
- New **[Perplexity](https://www.perplexity.ai/)** and **[Groq](https://groq.com/)** integration (thanks @Penagwin). [#407](https://github.com/enricoros/alpha-AGI/issues/407), [#427](https://github.com/enricoros/alpha-AGI/issues/427)
- **[LocalAI](https://localai.io/models/)** deep integration, including support for [model galleries](https://github.com/enricoros/alpha-AGI/issues/411)
...
https://github.com/enricoros/alpha-AGI/assets/32999/01732528-730e-41dc-adc7-511385686b13

- **Side-by-Side Split Windows**: multitask with parallel conversations. [#208](https://github.com/enricoros/alpha-AGI/issues/208)
- **Multi-Chat Mode**: message everyone, all at once. [#388](https://github.com/enricoros/alpha-AGI/issues/388)
- **Export tables as CSV**: big thanks to @aj47. [#392](https://github.com/enricoros/alpha-AGI/pull/392)
- Adjustable text size: customize density. [#399](https://github.com/enricoros/alpha-AGI/issues/399)
- Dev2 Persona Technology Preview
- Better looking chats with improved spacing, fonts, and menus
- More: new video player, [LM Studio tutorial](https://github.com/enricoros/alpha-AGI/blob/main/docs/config-local-lmstudio.md) (thanks @aj47), [MongoDB support](https://github.com/enricoros/alpha-AGI/blob/main/docs/deploy-database.md) (thanks @ranfysvalle02), and speedups
...
https://github.com/enricoros/alpha-AGI/assets/32999/95ceb03c-945d-4fdd-9a9f-3317beb54f3f

- **Voice Calls**: real-time voice call your personas out of the blue or in relation to a chat [#354](https://github.com/enricoros/alpha-AGI/issues/354)
- Support **OpenAI 0125** Models. [#364](https://github.com/enricoros/alpha-AGI/issues/364)
- Rename or Auto-Rename chats.  [#222](https://github.com/enricoros/alpha-AGI/issues/222), [#360](https://github.com/enricoros/alpha-AGI/issues/360)
- More control over **Link Sharing** [#356](https://github.com/enricoros/alpha-AGI/issues/356)
- **Accessibility** to screen readers [#358](https://github.com/enricoros/alpha-AGI/issues/358)
- Export chats to Markdown [#337](https://github.com/enricoros/alpha-AGI/issues/337)
- Paste tables from Excel [#286](https://github.com/enricoros/alpha-AGI/issues/286)
- Ollama model updates and context window detection fixes [#309](https://github.com/enricoros/alpha-AGI/issues/309)
...
https://github.com/enricoros/alpha-AGI/assets/1590910/a6b8e172-0726-4b03-a5e5-10cfcb110c68

- **Find chats**: search in titles and content, with frequency ranking. [#329](https://github.com/enricoros/alpha-AGI/issues/329)
- **Commands**: command auto-completion (type '/'). [#327](https://github.com/enricoros/alpha-AGI/issues/327)
- **[Together AI](https://www.together.ai/products#inference)** inference platform support (good speed and newer models). [#346](https://github.com/enricoros/alpha-AGI/issues/346)
...
- **New UI**: for both desktop and mobile, sets the stage for future scale. [#201](https://github.com/enricoros/alpha-AGI/issues/201)
- **Conversation Folders**: enhanced conversation organization. [#321](https://github.com/enricoros/alpha-AGI/issues/321)
...
Or bring your API keys and jump straight into our free instance on [alpha-AGI.com](https://alpha-agi.com).
...
- [ ] 💡 Got a feature suggestion? [_Add your roadmap ideas_](https://github.com/enricoros/alpha-agi/issues/new?&template=roadmap-request.md)
...
[//]: # ([![GitHub stars]&#40;https://img.shields.io/github/stars/enricoros/alpha-agi&#41;]&#40;https://github.com/enricoros/alpha-agi/stargazers&#41;)

[//]: # ([![GitHub forks]&#40;https://img.shields.io/github/forks/enricoros/alpha-agi&#41;]&#40;https://github.com/enricoros/alpha-agi/network&#41;)

[//]: # ([![GitHub pull requests]&#40;https://img.shields.io/github/issues-pr/enricoros/alpha-agi&#41;]&#40;https://github.com/enricoros/alpha-agi/pulls&#41;)

[//]: # ([![License]&#40;https://img.shields.io/github/license/enricoros/alpha-agi&#41;]&#40;https://github.com/enricoros/alpha-agi/LICENSE&#41;)
...
2023-2024 · Enrico Ros x [Alpha-AGI](https://alpha-agi.com) · Like this project? Leave a star! 💫⭐